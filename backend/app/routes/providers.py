...
PROVIDER_DETAILS = {
    ...
    "claude": {
        ...
        "models": ["claude-haiku-4-5", "claude-sonnet-4-6", "claude-3-5-haiku-20241022"],
        ...
        providers.append(
            {
                ...
                "execution_mode": diagnostic["execution_mode"],
                "will_use_real_provider": diagnostic["will_use_real_provider"],
                "will_use_mock": diagnostic["will_use_mock"],
